Reference<OwnershipExchangeMethod> — **shape**: **Reference** in [common-models.md](common-models.md). **Allowed values** (Finnish labels; closed set):
```
ei tietoa
huutokauppa
keruu
...
Reference<Technique> — **shape**: **Reference** in [common-models.md](common-models.md). **Allowed values** (Finnish labels; closed set):
```
akvatinta
etsaus
kuivaneula
...
Reference<TechniqueType> — **shape**: **Reference** in [common-models.md](common-models.md). **Allowed values** (Finnish labels; closed set):
```
...
Reference<AssociatedActivityType> — **shape**: **Reference** in [common-models.md](common-models.md). **Allowed values** (Finnish labels; closed set):
```
hankinta
omistus
valmistus
...
Reference<AssociatedCulturalAffinity> — **shape**: **Reference** in [common-models.md](common-models.md). **Allowed values** (Finnish labels; closed set):
```
afrikkalaisuus
espoolaisuus
eurooppalaisuus
...
Reference<AssociatedEventName> — **shape**: **Reference** in [common-models.md](common-models.md). **Allowed values** (Finnish labels; closed set):
```
...
Reference<AssociatedEventNameType> — **shape**: **Reference** in [common-models.md](common-models.md). **Allowed values** (Finnish labels; closed set):
```
kruunajaiset 
joukkomurha 
taistelu 
